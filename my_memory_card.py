...
Question_list = []
Question_list.append(Question("Государственный язык бразилии","Португальский","Испанский","Английский","Бразильский"))
...
lb_Question = QLabel('Cамый сложный вопрос в мире!')
...
lb_correct = QLabel("Тут будет ответ")
